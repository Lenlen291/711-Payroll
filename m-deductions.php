...
<body>
<nav class="nav">
  <p class="nav__title">DEDUCTIONS</p>
    ...
    <div class="sidebar">
        <div class="profile">
            ...
            <ul>
                ...
                <li>
                    <a href="m-deductions.php" class="active">
...
<table id="example1" class="form">
  ...
  <tbody>
  <?php
    if(is_array($fetch_me)){      
    foreach($fetch_me as $data){
    ?>
    ...
    <td>
    <a href=".delete_deduction.php?id=<?php echo $data['id']; ?>"><i style="text-decoration: none; color: #039b77;" class="fa fa-trash"></i></a></td>
    </td>  
    </tr>
    <?php
    }}
...
<div class="content">
  <form action=".put_deduction.php" method="post">
  <div class="user-details">
      ...
      <div class="input-box">
        ...
        <input type="number" step='0.01' z  name="percentage" required>
      </div>
