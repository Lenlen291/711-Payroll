...
<body>
    <nav class="nav">
      <p class="nav__title">ALLOWANCE</p>
        ...
        <div class="sidebar">
            <div class="profile">
                ...
                <ul>
                    ...
                    <li>
                        <a href="m-allowance.php" class="active">
                            <img class="icon" src="./image/allowance.png">
...
<table id="example1" class="form">
  ...
  <?php
    ...
    <td>
    <a href=".delete_allowance.php?id=<?php echo $data['id']; ?>"><i style="text-decoration: none; color: #039b77;" class="fa fa-trash"></i></a></td>
    </td>  
    </tr>
    <?php
    }}
...
<div class="content">
  <form action=".put_allowance.php" method="post">
